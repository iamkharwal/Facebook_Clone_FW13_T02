...
const StoryReel = () => {
  const { storyDiv } = useContext(DisplayStoryContext);
  console.log(storyDiv);
  return (
    <div>
      <div
        className="displayStory"
        style={{ display: storyDiv ? "block" : "none" }}
      >
        <StoryDisplay />
      </div>
      <div style={{ display: !storyDiv ? "block" : "none" }}>
        <div className="storyreel">
          <div
            ...
            style={{
              backgroundImage:
                "url(https://cdn.pixabay.com/photo/2017/07/31/22/45/fashion-2561753_1280.jpg)",
