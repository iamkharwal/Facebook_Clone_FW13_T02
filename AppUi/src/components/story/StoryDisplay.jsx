...
export const StoryDisplay = () => {
  const { storyDiv, togglestoryDiv, imageUrl, togglestoryDisplay } =
    useContext(DisplayStoryContext);
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", marginTop: "250px" }}>
        <button className="storySymbol" style={{ textAlign: "left" }}>
          ＜
        </button>
        <button
          className="storySymbol"
          style={{ textAlign: "right", marginLeft: "94%" }}
        >
          ＞
        </button>
      </div>
